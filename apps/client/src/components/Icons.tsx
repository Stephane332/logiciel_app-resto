...
export const BurgerMark = ({ size = 64, className, style }: IconProps) => (
  <svg viewBox="0 0 64 64" width={size} height={size} className={className} style={style} aria-hidden="true">
    <path d="M12 32a20 20 0 0 1 40 0Z" fill="currentColor" />
    <rect x="12" y="35" width="40" height="6.5" rx="3.25" fill="currentColor" opacity="0.55" />
    <path d="M12 44h40v4a5 5 0 0 1-5 5H17a5 5 0 0 1-5-5Z" fill="currentColor" />
  </svg>
);
